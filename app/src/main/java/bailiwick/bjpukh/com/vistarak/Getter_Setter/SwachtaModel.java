...
public class SwachtaModel {
    private String Str_vistarakID, Str_booth_id, Str_pramukh_name, Str_lat, Str_lan, Str_mobile, Str_entry_no;

    public SwachtaModel(String str_vistarakID, String str_booth_id, String str_pramukh_name, String str_lat, String str_lan, String str_mobile, String str_entry_no) {
